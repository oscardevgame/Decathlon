...
$databases = array(
	array(
		'path'=> 'corrida100mts.db',
		'name'=> 'Decathlon corrida100mts'
	),
	array(
		'path'=> '../../Model/Datasource/corrida100mts.sqlite',
		'name'=> 'Decathlon corrida100mts TESTE'
	),
);
